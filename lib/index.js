...
const subagentProgressProjection = {
  ...
  // v3: assistant/message without visible text no longer bumps updatedAt, so
  // a changed view always implies changed content (no broadcast heartbeat).
  stateVersion: 3
};
