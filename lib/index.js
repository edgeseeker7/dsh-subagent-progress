...
/** Maximum characters kept from a send_message/report headline. */
...
const subagentProgressProjection = {
  ...
  // v5: update messages preserve newlines (normalizeMarkdown) so lists and
  // other Markdown block constructs survive into client rendering; v4 added
  // lastAction and folding of send_message/report as updates.
  stateVersion: 5,
};
